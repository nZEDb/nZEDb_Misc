...
>>You must first copy the [nzedb/config/settings.php.example](https://github.com/nZEDb/nZEDb/blob/master/nzedb/config/settings.example.php) file to nzedb/config/settings.php  
>>Open up the nzedb/config/settings.php file in a text editor, scroll down to the "Cache Settings" section.  
